...
class CxlHitScenario : public benchmark_runner::IBenchScenario {
    ...
    // Destructive: cancels remove orders from the book.
    ...
    void Setup(const benchmark_runner::Args& args, std::uint64_t iter_idx) override {
        ...
        // total_ = total number of orders placed during prefill.
        // RunOp picks random IDs within [id_base_, id_base_ + total_).
