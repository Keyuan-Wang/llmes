...
class MktSweepDeepScenario : public benchmark_runner::IBenchScenario {
    ...
    // Destructive: the market order consumes resting liquidity.
    ...
    bool RunOp(const benchmark_runner::Args& args, std::uint64_t,
        ...
        // Request args.levels * 2 shares — enough to sweep all levels
        // with some leftover that triggers MarketRemainderCancelled.
